...
| `503` + `Token alinamadi (400/401)` | `saak`/`sask` yanlış ya da servis hesabı yenilenmiş |
| `503` + `IONAPI_B64 cozulemedi` | Base64 eksik/bozuk kopyalanmış |
| `503` + `.ionapi icerigi eksik alanlar` | Dosyada `ci`/`cs`/`saak`/`sask` eksik |
